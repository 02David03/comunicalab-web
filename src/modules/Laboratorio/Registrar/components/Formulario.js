...
const Formulario = (props) => {
  // Logica responsavel por tratar das mensagens de alerta se o usuario estiver fazendo algo errado quanto ao preenchimento do form
  ...
  // É aqui que os dados serão guardados e consequentemente passados para depois serem submitados pela função que vem de index.js
...
//Requerição das dependencias(funções e array) são feitas por aqui
